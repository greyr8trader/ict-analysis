...
- If current conditions conflict with memory, memory must be ignored.

────────────────────────────────────────
1) HIGHER-TIMEFRAME CONTEXT (D → H1 → M15)
────────────────────────────────────────
- Using the provided OHLC data, define the active dealing range.
- Identify the current external liquidity draw:
...
- Liquidity must be interpreted strictly per RULEBOOK definitions.
